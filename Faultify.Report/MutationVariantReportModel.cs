...
namespace Faultify.Report
{
    public class MutationVariantReportModel
    {
        ...
        public MutationVariantReportModel(string name, string description, MutationAnalyzerReportModel mutationAnalyzer, MutationStatus testStatus, TimeSpan testDuration, string originalSource, string mutatedSource)
        {
            Name = name;
