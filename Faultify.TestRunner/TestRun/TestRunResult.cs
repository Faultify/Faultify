...
namespace Faultify.TestRunner.TestRun
{
    ...
    public class TestRunResult
    {
        ...
        {
            IEnumerable<TestResult>? nonResultTests = TestResults.Tests.Where(x => x.Outcome == TestOutcome.None);

            List<MutationVariantIdentifier>? timedOutTests = new List<MutationVariantIdentifier>();
